...
const AddEduccation = ({ addEducation, history }) => {
    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={e => {
                ...
                <div className="form-group">
                    <input type="text" placeholder="* Degrre or Certificate" name="degree" value={degree} onChange={e => onChange(e)} required />
                </div>
                <div className="form-group">
...
AddEduccation.propTypes = {
    addEducation: PropTypes.func.isRequired
};

export default connect(null, { addEducation })(withRouter(AddEduccation));
